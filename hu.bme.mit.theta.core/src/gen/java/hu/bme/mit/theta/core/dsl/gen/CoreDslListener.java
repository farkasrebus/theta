...
public interface CoreDslListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link CoreDslParser#negExpr}.
	 * @param ctx the parse tree
	 */
	void enterNegExpr(CoreDslParser.NegExprContext ctx);
	/**
	 * Exit a parse tree produced by {@link CoreDslParser#negExpr}.
	 * @param ctx the parse tree
	 */
	void exitNegExpr(CoreDslParser.NegExprContext ctx);
	/**
